	...
	<div class="node-wrap">
		<div class="node-wrap-box" @click="show">
			<div class="title" style="background: #ff943e;">
				...
				<el-icon class="close" @click.stop="delNode()"><CloseBold /></el-icon>
			</div>
			<div class="content">
		...
		<el-drawer title="审批人设置" v-model="drawer" destroy-on-close append-to-body :size="500">
			<template #header>
				<div class="node-wrap-drawer__title">
					<label @click="editTitle" v-if="!isEditTitle">{{form.nodeName}}<el-icon class="node-wrap-drawer__title-edit"><EditPen /></el-icon></label>
			...
			<el-container>
                ...
                <el-icon ><Plus/></el-icon>选择人员
						...
						<el-form-item v-if="form.setType==3" label="选择角色">
							<el-button type="primary"  round @click="selectHandle(2, form.nodeRoleList)"><el-icon><Plus/></el-icon>选择角色</el-button>
							<div class="tags-list">
...
<script>
  ...
  import {CloseBold, EditPen, Plus} from "@element-plus/icons-vue";
