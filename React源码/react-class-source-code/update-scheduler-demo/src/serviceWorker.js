...
// This lets the pages load faster on subsequent visits in production, and gives
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log(
            'This web pages is being served cache-first by a service ' +
  ...
  fetch(swUrl)
    .then(response => {
      ...
      if (
        ...
        // No service worker found. Probably a different pages. Reload the pages.
